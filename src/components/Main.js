...
const Main = ({ setError, setErrMsg }) => {
    ...
    return (
        <div className="container mx-auto md:max-w-5xl px-4 text-[color:var(--font-color)] mt-14 font-Poppins">
            ...
            <div className="main flex items-center justify-between flex-wrap md:flex-nowrap">
                <div className="w-full md:w-1/2 mb-8 z-10">
                    <div className="stakePanel bg-[color:var(--cards-bg)] p-6 w-full">
                        <h3 className="uppercase font-semibold text-md font-Poppins text-left" style={{textShadow: "0 0 0.17em #fff, 0 0 1.1em #fff"}}>Participate CRNO Stake</h3>
                        ...
                        <div className="flex min-h-[8rem] bg-[color:var(--cards-bg)] w-full p-8 items-start justify-between text-left">
                            ...
                            <div>
                                <svg id="chart" width="100%" height="50" viewBox="0 0 80 30" xmlns="http://www.w3.org/2000/svg" >
                                    <path d="  M0,30  h8  v-0.7098142461564727  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M10,30  h8  v-3.8886121736656065  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M20,30  h8  v-7.535516905963142  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M30,30  h8  v-9.867032085607057  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M40,30  h8  v-14.308029708931354  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M50,30  h8  v-13.650666700270385  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M60,30  h8  v-17.03132200231409  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                        ...
                        <div className="flex min-h-[8rem] bg-[color:var(--cards-bg)] w-full p-8 items-start text-left justify-between">
                            ...
                            <div>
                                <svg id="chart" width="100%" height="50" viewBox="0 0 80 30" xmlns="http://www.w3.org/2000/svg" >
                                    ...
                                    <path d="  M0,30  h8  v-0.3559955903768852  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M10,30  h8  v-3.2730281691498107  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M20,30  h8  v-4.129306820057437  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M30,30  h8  v-11.36131403794074  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M40,30  h8  v-10.952211091320216  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M50,30  h8  v-14.499437557106283  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M60,30  h8  v-16.20159452944091  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M70,30  h8  v-19.139616076129972  q0,-0 -0,-0  h-8  q-0,0 -0,0  Z" fill="#b28760" />
                                </svg>
                            </div>
                        </div>
                        <div className="flex min-h-[8rem] bg-[color:var(--cards-bg)] w-full p-8 items-start text-left justify-between">
                            ...
                            <div>
                                <svg id="chart" width="100%" height="50" viewBox="0 0 120 50" xmlns="http://www.w3.org/2000/svg" >
                                    ...
                                    <path d="  M0,50  h12  v-0.2691140789513824  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M15,50  h12  v-6.1035534408604875  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M30,50  h12  v-12.85295830169808  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M45,50  h12  v-17.121537297632287  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M60,50  h12  v-27.99841373754431  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M75,50  h12  v-32.02205622140259  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M90,50  h12  v-29.322334941779435  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                    <path d="  M105,50  h12  v-24.598795157806162  q0,-0 -0,-0  h-12  q-0,0 -0,0  Z" fill="#b28760" />
                                </svg>
                            </div>
                        </div>
            ...
            {account && (
                <div className="stakePanel bg-[color:var(--cards-bg)] p-6 w-full mb-24">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mt-4 md:space-x-10 truncate">
                        <div className="bg-slate-200 bg-opacity-5 px-6 py-4 w-full rounded-lg mb-6 md:mb-0">
                            <h2 className="text-xl text-center font-bold mb-4 uppercase border-b pb-2 border-white border-opacity-20 text-[#b28760]">1 Month</h2>
                        ...
                        <div className="bg-slate-200 bg-opacity-5 px-6 py-4 w-full rounded-lg mb-6 md:mb-0">
                            <h2 className="text-xl text-center font-bold mb-4 uppercase border-b pb-2 border-white border-opacity-20 text-[#b28760]">3 Months</h2>
                        ...
                        <div className="bg-slate-200 bg-opacity-5 px-6 py-4 w-full rounded-lg mb-6 md:mb-0">
                            <h2 className="text-xl text-center font-bold mb-4 uppercase border-b pb-2 border-white border-opacity-20 text-[#b28760]">6 Months</h2>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mt-4 md:space-x-10 truncate">
                        <div className="bg-slate-200 bg-opacity-5 px-6 py-4 w-full rounded-lg mb-6 md:mb-0">
                            <h2 className="text-xl text-center font-bold mb-4 uppercase border-b pb-2 border-white border-opacity-20 text-[#b28760]">9 Months</h2>
                        ...
                        <div className="bg-slate-200 bg-opacity-5 px-6 py-4 w-full rounded-lg mb-6 md:mb-0">
                            <h2 className="text-xl text-center font-bold mb-4 uppercase border-b pb-2 border-white border-opacity-20 text-[#b28760]">12 Months</h2>
